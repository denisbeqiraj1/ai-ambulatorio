        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex flex-col items-center justify-center p-4 font-sans text-slate-800">
            ...
            <div className="absolute top-4 right-4">
                <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur rounded-xl text-slate-600 hover:text-red-600 hover:bg-red-50 transition-all shadow-sm border border-slate-200"
                >
                                    ...
                                    <div className="p-6">
                                        ...
                                        <div className="flex items-center justify-between text-sm border-t border-slate-100 pt-4">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className={`px-2.5 py-0.5 rounded-full text-xs font-medium ${result.source.includes('OpenAI') ? 'bg-emerald-100 text-emerald-700' : 'bg-blue-100 text-blue-700'
                                                    }`}>
                                                    {result.source}
                                                </span>
                                            </div>
